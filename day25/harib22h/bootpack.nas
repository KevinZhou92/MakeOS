...
L86:
	...
	TEST	EAX,EAX
	JE	L7
	MOV	EDX,DWORD [-772+EBP]
	MOV	ECX,DWORD [-776+EBP]
	ADD	DWORD [-1072+EBP],EDX
	ADD	DWORD [-1068+EBP],ECX
	JS	L87
L51:
...
L89:
	...
	SUB	EBX,DWORD [-1128+EBP]
	MOV	ESI,DWORD [-1068+EBP]
	SUB	ESI,DWORD [-1124+EBP]
...
L99:
	...
	JMP	L39
L98:
	AND	DWORD [-1112+EBP],-3
	JMP	L38
L97:
	AND	DWORD [-1112+EBP],-2
	JMP	L37
L96:
	OR	DWORD [-1112+EBP],2
	JMP	L36
