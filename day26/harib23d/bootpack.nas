...
L48:
	...
	MOV	DWORD [-1088+EBP],ECX
	MOV	DWORD [-1092+EBP],EAX
	TEST	DWORD [-768+EBP],1
	JNE	L79
	MOV	DWORD [-1132+EBP],-1
	CMP	DWORD [-1096+EBP],2147483647
	JE	L7
L70:
	PUSH	DWORD [-1100+EBP]
	PUSH	DWORD [-1096+EBP]
...
L79:
	...
	SUB	EBX,DWORD [-1132+EBP]
	MOV	ESI,DWORD [-1080+EBP]
	SUB	ESI,DWORD [-1136+EBP]
	MOV	EDX,DWORD [-1080+EBP]
	LEA	EBX,DWORD [2+EBX+EAX*1]
	MOV	DWORD [-1136+EBP],EDX
	MOV	DWORD [-1096+EBP],EBX
	ADD	DWORD [-1100+EBP],ESI
	AND	DWORD [-1096+EBP],-4
	JMP	L7
L80:
	MOV	EDX,DWORD [-1072+EBP]
